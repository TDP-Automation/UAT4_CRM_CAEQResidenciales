...
''''''''Seleccion Opciones de SIM
	...
	''Pantalla de Equipo
		...
		If JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel").Exist Then
			...
			While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel_4").Exist=False
						wait 1
				Wend
					
					Dim text
					text=JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel_4").GetROProperty("text")
				While text=""
						wait 1
						text=JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel_4").GetROProperty("text")
				Wend
...
Sub DetalleActividadOrden()
	...
	dim Iterator , filas	
	filas=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 713979A").JavaTable("SearchJTable").GetAllROProperties("rows")
	For Iterator = filas-1 To 0 step -1	    
