...
Sub ValidaNPC(cuota)
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("JDialog").JavaObject("JOptionPane").Exist= True Then
		While JavaWindow("Ejecutivo de interacción").JavaDialog("JDialog").JavaStaticText("El Plan de Financiamiento").Exist =False 
			wait 1
		Wend
	...
	Call Carga()
		...
		Case 12
			...
			Call Carga()
			wait 1
			JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"Calculo12.png", True
	        imagenToWord "Monto calculado financiado 12 cuotas ",RutaEvidencias() &"Calculo12.png"
