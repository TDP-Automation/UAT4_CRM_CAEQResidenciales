...
''''''''Seleccion Opciones de SIM
	...
	''Pantalla de Equipo
		...
		If JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel").Exist Then
			...
			wait 1
				...
				While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel_5").Exist=False
						wait 1
				Wend
					
					Dim text
					text=JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel_5").GetROProperty("text")
				While text=""
						wait 1
						text=JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaObject("PanelNative$JXPanel_5").GetROProperty("text")
				Wend
					wait 5
				Select Case DataTable("e_Equipo_Movil",dtLocalSheet)
				  Case "HUAWEI P10 NEGRO"
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaDialog("Mensaje").Exist=True Then
		wait 2
		varlog2=JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaDialog("Mensaje").JavaObject("JPanel").GetROProperty("text")
		DataTable("s_Resultado", dtLocalSheet) = "Fallido"		
		DataTable("s_Detalle", dtLocalSheet) = varlog2
		Reporter.ReportEvent micFail, DataTable("s_Resultado", dtLocalSheet), DataTable("s_Detalle", dtLocalSheet)
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "MensajeValidacionE.png", True
		imagenToWord "Error en SAP",RutaEvidencias() & "MensajeValidacionE.png"
		wait 3
		JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaDialog("Mensaje").JavaButton("OK").Click
		wait 3
		JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaButton("Cancelar").Click
...
RunAction "ValFinanciamiento", oneIteration
	...
	IF ucase(str_Financiamiento) = "SI"  Then
	     If str_Cuotas = 18 Then
		    ...
		    If JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").Exist=True Then
		 		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "PantallaNegociarConfiguración2.png", True
				imagenToWord "Mensaje problema",RutaEvidencias() & "PantallaNegociarConfiguración2.png"
            ...
            If JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").Exist=True Then
		   	...
		   	wait 2
		   	If JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").Exist=True Then
         		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "PantallaNegociarConfiguración1.png", True
				imagenToWord "Mensaje problema",RutaEvidencias() & "PantallaNegociarConfiguración1.png"
				wait 2
         		JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").JavaButton("OK").Click
      		End If
		     wait 1
		     ...
		     ElseIf DataTable("e_Cuotas",dtLocalSheet) = 12 Then
		     wait 5
			...
			If JavaWindow("Ejecutivo de interacción").JavaDialog("JDialog").JavaStaticText("El Plan de Financiamiento").Exist=True Then
						DataTable("s_Resultado", dtLocalSheet) = "Fallido"
						DataTable("s_Detalle", dtLocalSheet) = "plan de financiamiento no disponible"
						Reporter.ReportEvent micFail, DataTable("s_Resultado", dtLocalSheet), DataTable("s_Detalle", dtLocalSheet)
						JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "MensajeVa.png", True
						imagenToWord "Plan de financiamiento no disponible",RutaEvidencias() & "MensajeVa.png"
						wait 2
	...
	End If
	 ...
	 If JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").Exist=True Then
         	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "PantallaNegociarConfiguraciónn.png", True
			imagenToWord "Mensaje problema",RutaEvidencias() & "PantallaNegociarConfiguraciónn.png"
			wait 2
         	JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").JavaButton("OK").Click
	...
	wait 5
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").Exist=True Then
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "PantallaNegociarConfiguración3.png", True
		imagenToWord "Mensaje problema-Fallido",RutaEvidencias() & "PantallaNegociarConfiguración3.png"
		DataTable("s_Resultado","CAEQ_EquipoYSim") ="Fallido"
		DataTable("s_Detalle","CAEQ_EquipoYSim") ="Error mensaje"
	...
	While ((JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de").JavaRadioButton("En tienda").Exist) Or (JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 599306A").JavaButton("Pago inmediato").Exist) Or (JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución_2").JavaEdit("ID del Acuerdo de Facturación:").Exist))= false
    	wait 1
    Wend
	If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de").JavaRadioButton("En tienda").Exist=True Then
	  Call TipoEnvio()
	   ElseIf JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución_2").JavaEdit("ID del Acuerdo de Facturación:").Exist=True Then
...
'	
	...
	Call esperaCarga
	While (JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validade y Ver Contrato").Exist) Or (JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 599306A").JavaButton("Pago inmediato").Exist)=False
		wait 1
	Wend
	
	If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 599306A").JavaButton("Pago inmediato").Exist=True Then
		Call pagoInmediato()		
	End If
End Sub
Sub pagoInmediato
...
'			JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 599306A").JavaCheckBox("Financiamiento Externo").Set "ON"
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").Exist=True Then
						...
						varlog = JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").JavaObject("ExceptionPane").GetROProperty("text")	
'						varlog2= Replace(varlog, "<html>","") 
'						varlog2= Replace(varlog, "</html>","")
'						varlog = Instr(1,varlog,"Error en el sistema externo. Plan de financiamiento no existe")
'						wait 1
'						
						DataTable("s_Resultado", dtLocalSheet) = "Fallido"
						...
						wait 3
				JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 599306A").JavaButton("Cancelar acción de orden").Click
					While JavaWindow("Ejecutivo de interacción").JavaDialog("Seleccionar una opción").Exist=False
						wait 1
					Wend
					 wait 1
					...
					While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Pago (Orden 1094678A").JavaTable("Acciones de orden que").Exist=False
						wait 1
					Wend
					
					wait 1
					JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Pago (Orden 1094678A").JavaButton("Aceptar").Click
...
Sub GestionLogistica()
	...
	wait 1
		...
		If  JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaButton("ftp://172.28.69.93/pub/DOC004-").exist Then
			Reporter.ReportEvent micPass, "Exito", "Se visualiza correctamente controlador fiscal"
			
			JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "ControladorFiscal.png", True
					imagenToWord "Controlador Fiscal",RutaEvidencias() & "ControladorFiscal.png"
		End If
